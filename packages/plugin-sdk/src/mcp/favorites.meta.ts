...
export const FavoritesAPIMeta: DomainMeta = {
  ...
  methods: {
    ...
    removeArtistByName: {
      name: 'removeArtistByName',
      description: 'Remove an artist from favorites by name (tombstone by name key).',
    ...
    getDeletedKeys: {
      name: 'getDeletedKeys',
      description: 'Get the tombstone map of deleted favorites keys.',
      params: [],
